export default {
  ...
  automationAndScraping: ["Selenium", "BeautifulSoup"],
  coreConcepts: ["Authentication (JWT)", "Role-Based Access Control", "WebSockets", "Database Design", "API Security", "System Architecture"],
};
